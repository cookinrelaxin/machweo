...
@property (nonatomic, strong) NSMutableArray* obstacleArray;
@property (nonatomic, strong) NSMutableArray* decorationArray;
@property (nonatomic, strong) NSMutableArray* terrainPoolArray;
